...
class Ui_DataAnalyse(object):
    def setupUi(self, DataAnalyse):
        ...
        self.pb_da.setGeometry(QtCore.QRect(400, 340, 75, 23))
        self.pb_da.setObjectName("pb_da")
        self.pb_plot = QtWidgets.QPushButton(DataAnalyse)
        self.pb_plot.setGeometry(QtCore.QRect(660, 340, 75, 23))
        ...
        self.pb_downcsv.setGeometry(QtCore.QRect(485, 340, 75, 23))
